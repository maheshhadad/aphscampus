      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/school/category' ?>"><i class="fa fa-circle-o"></i>Category</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/school/classes' ?>"><i class="fa fa-circle-o"></i>Classes</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/school/course' ?>"><i class="fa fa-circle-o"></i>Course</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/student/student_registration' ?>"><i class="fa fa-circle-o"></i>Student Registration</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/staff/manage_staff' ?>"><i class="fa fa-circle-o"></i>Staff</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Attendance Managent</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/attendance/' ?>"><i class="fa fa-circle-o"></i>Attendance</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Exam Managent</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/exam/add_exam' ?>"><i class="fa fa-circle-o"></i>Add Exam</a></li>
            <li class="active"><a href="<?php echo base_url().'index.php/exam/add_time_table' ?>"><i class="fa fa-circle-o"></i>Add Time Table</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Result Managent</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'index.php/result' ?>"><i class="fa fa-circle-o"></i>Result</a></li>
          </ul>
        </li>
      </ul>
    </section>
